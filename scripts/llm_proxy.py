...
async def chat_completions(payload: ChatCompletionsRequest) -> JSONResponse:
    ...
    user_prompt = (
        ...
        "LANGUAGE:\n"
        "- Reply in the same language as USER_QUESTION.\n"
        "- If USER_QUESTION is in Spanish, answer in Spanish.\n\n"
        "SOCIAL RULE:\n"
        "- If USER_QUESTION is only gratitude or greeting (e.g., 'gracias', 'thanks', 'hola'),\n"
        "  reply briefly and naturally in that language, without repeating article summary.\n\n"
        "OUTPUT RULES:\n"
